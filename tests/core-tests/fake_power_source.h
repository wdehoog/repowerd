...
public:
    ...
    struct Mock
    {
        ...
        MOCK_METHOD1(register_power_source_level_change_handler, void(PowerSourceLevelChangeHandler const&));
        MOCK_METHOD0(unregister_power_source_level_change_handler, void());
    };
